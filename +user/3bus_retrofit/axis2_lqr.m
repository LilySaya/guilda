...
model_agc = ss([zeros(5,3);ki/omega0 kp 0]);
model_agc.InputGroup.delta_agc = 1;
model_agc.InputGroup.omega_agc = 2;
...
legend('retrofit with model agc','retrofit without environ model')
%}
%fault
time = [0,100];
